...
namespace Structure.Infrastructure.Migrations
{
    ...
    [Migration("20240502131812_addAllModeles2")]
    partial class addAllModeles2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Structure.Domain.CompanyAggregate.LookUp.CompanyStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Structure.Domain.CompanyEmployeeInfromationAggregate.Lookup.CompanyEmployeeStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Structure.Domain.CompanyEmployeeInfromationAggregate.Models.EmployeeServiceTermination", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Structure.Domain.CompanyEmployeeInfromationAggregate.Models.InjuryAndDeathRegistration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Structure.Domain.DepartmentsaAggregate.Models.CompanyDepartmentPolicies", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Structure.Domain.DepartmentsaAggregate.Models.CompanyDepartmentPoliciesIsReaded", b =>
                {
                    b.Property<Guid>("CompanyId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Structure.Domain.DepartmentsaAggregate.Models.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Structure.Domain.EmployeeAggregate.Lookup.Countries", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Structure.Domain.EmployeeAggregate.Lookup.CountriesStates", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Structure.Domain.EmployeeAggregate.Lookup.DocumentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Structure.Domain.EmployeeAggregate.Lookup.Gender", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Structure.Domain.EmployeeAggregate.Lookup.MaritalStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Structure.Domain.EmployeeAggregate.Lookup.RelativeRelation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Structure.Domain.EmployeeAggregate.Lookup.Religion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Structure.Domain.EmployeeAggregate.Models.Certificates", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Structure.Domain.EmployeeAggregate.Models.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Structure.Domain.EmployeeAggregate.Models.EmployeeDocuments", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Structure.Domain.EmployeeAggregate.Models.FamilyDocuments", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Structure.Domain.EmployeeAggregate.Models.FamilyInformation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Structure.Domain.EmployeeAggregate.Models.WorkHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Structure.Domain.EmployeePositionsAggregate.Models.EmployeePositions", b =>
                {
                    b.Property<Guid>("DepartmentId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Structure.Domain.JobAggregate.Models.Job", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Structure.Domain.OccupationAggregate.Models.Occupation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Structure.Domain.CompanyAggregate.Models.Company", b =>
                {
                    ...
                    b.HasOne("Structure.Domain.CompanyAggregate.LookUp.CompanyStatus", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("Structure.Domain.CompanyEmployeeInfromationAggregate.Models.CompaniesEmployeeInformations", b =>
                {
                    b.HasOne("Structure.Domain.CompanyAggregate.Models.Company", "Company")
                        .WithMany("CompaniesEmployeeInformations")
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Structure.Domain.EmployeeAggregate.Models.Employee", "Employee")
                        .WithMany("CompaniesEmployeeInformations")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Structure.Domain.CompanyEmployeeInfromationAggregate.Lookup.Role", "role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Structure.Domain.CompanyEmployeeInfromationAggregate.Lookup.CompanyEmployeeStatus", "status")
                        .WithMany()
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Structure.Domain.CompanyEmployeeInfromationAggregate.Models.EmployeeServiceTermination", b =>
                {
                    b.HasOne("Structure.Domain.CompanyEmployeeInfromationAggregate.Lookup.TerminationReasons", "TerminationReasons")
                        .WithMany()
                        .HasForeignKey("TerminationReasonsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Structure.Domain.CompanyEmployeeInfromationAggregate.Models.CompaniesEmployeeInformations", "CompaniesEmployeeInformations")
                        .WithMany()
            ...
            modelBuilder.Entity("Structure.Domain.CompanyEmployeeInfromationAggregate.Models.InjuryAndDeathRegistration", b =>
                {
                    b.HasOne("Structure.Domain.CompanyEmployeeInfromationAggregate.Lookup.InjuryTypes", "InjuryTypes")
                        .WithMany()
            ...
            modelBuilder.Entity("Structure.Domain.DepartmentJobsAggregate.Models.DepartmentsJobs", b =>
                {
                    b.HasOne("Structure.Domain.DepartmentsaAggregate.Models.Department", "Department")
                        .WithMany("departmentsJobs")
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Structure.Domain.JobAggregate.Models.Job", "Job")
                        .WithMany("departmentsJobs")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Structure.Domain.DepartmentsaAggregate.Models.CompanyDepartmentPoliciesIsReaded", b =>
                {
                    b.HasOne("Structure.Domain.DepartmentsaAggregate.Models.CompanyDepartmentPolicies", "CompanyDepartmentPolicies")
            ...
            modelBuilder.Entity("Structure.Domain.DepartmentsaAggregate.Models.Department", b =>
                {
                    ...
                    b.HasOne("Structure.Domain.CompanyEmployeeInfromationAggregate.Models.CompaniesEmployeeInformations", "EmployeeInformations")
                        .WithMany()
            ...
            modelBuilder.Entity("Structure.Domain.EmployeeAggregate.Lookup.CountriesStates", b =>
                {
                    b.HasOne("Structure.Domain.EmployeeAggregate.Lookup.Countries", "Countries")
                        .WithMany()
            ...
            modelBuilder.Entity("Structure.Domain.EmployeeAggregate.Models.Employee", b =>
                {
                    ...
                    b.HasOne("Structure.Domain.EmployeeAggregate.Lookup.Countries", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Structure.Domain.EmployeeAggregate.Lookup.Gender", "Gender")
                        .WithMany()
                        .HasForeignKey("GenderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Structure.Domain.EmployeeAggregate.Lookup.MaritalStatus", "MaritalStatus")
                        .WithMany()
                        .HasForeignKey("MaritalStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Structure.Domain.EmployeeAggregate.Lookup.Religion", "Religion")
                        .WithMany()
            ...
            modelBuilder.Entity("Structure.Domain.EmployeeAggregate.Models.EmployeeDocuments", b =>
                {
                    b.HasOne("Structure.Domain.EmployeeAggregate.Lookup.DocumentType", "DocumentType")
                        .WithMany()
            ...
            modelBuilder.Entity("Structure.Domain.EmployeeAggregate.Models.FamilyDocuments", b =>
                {
                    ...
                    b.HasOne("Structure.Domain.EmployeeAggregate.Models.FamilyInformation", "FamilyInformation")
            ...
            modelBuilder.Entity("Structure.Domain.EmployeeAggregate.Models.FamilyInformation", b =>
                {
                    ...
                    b.HasOne("Structure.Domain.EmployeeAggregate.Lookup.RelativeRelation", "RelativeRelation")
                        .WithMany()
            ...
            modelBuilder.Entity("Structure.Domain.EmployeePositionsAggregate.Models.EmployeePositions", b =>
                {
                    ...
                    b.HasOne("Structure.Domain.DepartmentJobsAggregate.Models.DepartmentsJobs", "DepartmentsJobs")
                        .WithMany("employeePositions")
            ...
            modelBuilder.Entity("Structure.Domain.JobAggregate.Models.Job", b =>
                {
                    b.HasOne("Structure.Domain.OccupationAggregate.Models.Occupation", "occupation")
                        .WithMany("Job")
